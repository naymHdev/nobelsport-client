          ...
          <Card className=" border-none shadow-none">
            <CardHeader>
              <div className=" flex items-start justify-between">
                ...
                <button className="flex items-center justify-center gap-1 text-center bg-[#D1FAE5] text-ns-primary text-xs md:text-base px-3 md:px-4 py-1.5 md:py-2 rounded-full font-openSans font-semibold hover:bg-[#b7f4d4] transition-all duration-200">
                  {matches?.length} <span>Match</span>
                </button>
              </div>
                    ...
                    <Card className=" border-none shadow-none font-openSans">
                      ...
                      <div className="md:mx-10 mx-4 rounded-xl border shadow-sm py-4 px-6 flex flex-col md:flex-row gap-6 md:gap-0 items-center justify-between">
                        <div className=" flex items-center text-center md:gap-5 gap-8">
                          <div>
                            <h2 className=" text-ns-title font-semibold md:font-bold text-sm md:text-base">
